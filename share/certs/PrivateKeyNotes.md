...
unlocked to sign the bowscoin-Qt.app bundle.
...
allowing somebody to distribute a bowscoin-Qt.app or bowscoin-qt-setup.exe with a valid
...
that the bowscoin-qt.exe file inside the installer had not been tampered with.
